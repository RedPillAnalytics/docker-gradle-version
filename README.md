...
* Write our version and tag to `stepvars/version.txt` and `stepvars/tag.txt` respectively in case we need them in other non-Gradle tools in subsequent build steps.
